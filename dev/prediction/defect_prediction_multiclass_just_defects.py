...
if import_test_train_data == 1:
    ...
    if augmentation == 1:
        ...
        x_train = pd.read_excel(
            r'..\data\split_train_test_data\just_defects\just_defects_x_train_aug.xlsx')

        y_train = pd.read_excel(
            r'..\data\split_train_test_data\just_defects\just_defects_y_train_aug.xlsx')['Defect Code']

    else:

        x_train = pd.read_excel(
            r'..\data\split_train_test_data\just_defects\just_defects_x_train.xlsx')

        y_train = pd.read_excel(
            r'..\data\split_train_test_data\just_defects\just_defects_y_train.xlsx')['Defect Code']

    x_test = pd.read_excel(r'..\data\split_train_test_data\just_defects\just_defects_x_test.xlsx')

    y_test = pd.read_excel(r'..\data\split_train_test_data\just_defects\just_defects_y_test.xlsx')[
        'Defect Code']
...
if import_test_train_data == 0:
    ...
    if augmentation == 1:
        ...
        if make_plots == 1:
            ...
            output_path = os.path.join(aug_plots_dir, 'just_defects_before_and_after.png')
    ...
    if augmentation == 1:
        ...
        pd.Series(y_train, name='Defect Code').to_excel(
            r'..\data\split_train_test_data\just_defects\just_defects_y_train_aug.xlsx',
            index=False)
        ...
        pd.Series(y_train, name='Defect Code').to_excel(
            r'..\data\split_train_test_data\just_defects\just_defects_y_train.xlsx',
            index=False)

    pd.DataFrame(x_test, columns=column_names).to_excel(
        r'..\data\split_train_test_data\just_defects\just_defects_x_test.xlsx',
        index=False)

    pd.Series(y_test, name='Defect Code').to_excel(
        r'..\data\split_train_test_data\just_defects\just_defects_y_test.xlsx',
        index=False)
...
if load_models == 1:
    rndforest = load(r'models/just_defects/just_defects_random_forest_model.pkl')
else:
...
plt.savefig(r'..\plots\confusion_matrix\just_defects\rf.png')
plt.show()
...
# Save
if load_models == 0:
    dump(rndforest, r'models/just_defects/just_defects_random_forest_model.pkl')
...
if load_models == 1:
    xgb_model.load_model(r'models\just_defects\just_defects_xgb_model.json')
else:
...
plt.savefig(r'..\plots\confusion_matrix\just_defects\xgboost.png')
plt.show()
...
# Save
if load_models == 0:
    xgb_model.save_model(r'models\just_defects\just_defects_xgb_model.json')
...
#
# if load_models == 1:
#     svm_model = load(r'..\models\just_defects\just_defects_svm_model.pkl')
# else:
...
# plt.savefig(r'..\plots\confusion_matrix\just_defects\svm.png')
# plt.show()
#
...
# # Save
# if load_models == 0:
#     dump(svm_model, r'..\models\just_defects\just_defects_svm_model.pkl')
...
if load_models == 1:
    catboost_model = CatBoostClassifier(loss_function='MultiClass', verbose=False)
    catboost_model.load_model(r'models\just_defects\just_defects_catboost_model.cbm')
else:
...
plt.savefig(r'..\plots\confusion_matrix\just_defects\catboost.png')
plt.show()
